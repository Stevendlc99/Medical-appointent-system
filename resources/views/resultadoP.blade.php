...
<body>
                                ...
                                <table class="table mb-0 table-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-bottom p-3">Response</th>
    ...
    @foreach ($registros as $registro)
      ...
      <td>{{ $registro->name }}</td>
        ...
        <td>{{ $registro->response }}</td>
        <td>
      <form action="{{ route('users.updateResponse', $registro->subject) }}" method="POST">
        @csrf
        <div class="form-group">
          <input type="text" name="response" value="{{ $registro->response }}" class="form-control">
        </div>
